        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [
            {
                ...
                },
                {
                    ...
                    template: function (data) {
                        return '<audio controls src = "/tracks/' + data.trackUrl + '"></audio>';
                    }
                },
                {
                    field: 'createdAt',
                ...
                },
            {
                ...
                template: function (data) {
                    ...
                    buttons = buttons + '\<a  href ="/track/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.title + ' ">\
                        ...
                        <a href ="/track/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
                        ...
                        <a class="PopUp btn btn-sm btn-clean btn-icon mr-2" href="/track/GetLog/' + data.id + '">\
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
        ...
        <path d="M18,7 C19.1045695,7 20,6.1045695 20,5 C20,3.8954305 19.1045695,3 18,3 C16.8954305,3 16,3.8954305 16,5 C16,6.1045695 16.8954305,7 18,7 Z M18,9 C15.790861,9 14,7.209139 14,5 C14,2.790861 15.790861,1 18,1 C20.209139,1 22,2.790861 22,5 C22,7.209139 20.209139,9 18,9 Z" fill="#000000" fill-rule="nonzero"/>\
                    ...
                    if (data.status == 'Pending') {
                        buttons = buttons +
                            '<a href="/track/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="موافقة" >\
...
<a href="/track/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="رفض" >\
